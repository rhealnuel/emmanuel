                ...
                <div className="flex flex-col-reverse lg:flex-row justify-between w-screen items-center lg:gap-6 pb-4 pl-2 pr-2  lg:pl-10 lg:pr-20 pt-10 overflow-x-hidden">
                    <div className='flex flex-col gap-6 w-[100%] lg:w-full items-center' data-aos="fade-right" data-aos-duration="3000">
                        ...
                        <div className='flex flex-col lg:pl-12 lg:flex-row gap-6 lg:gap-24 w-screen lg:w-full items-center'>
                           ...
                           <a href={pdf} download> <button className='text-[#0077FF] h-12 lg:w-44 w-[300px] outline outline-[#0077FF] rounded-3xl text-[18px] font-semibold bg-white'>Download CV</button> </a>
                        </div>
                    </div>
                    <div className="w-[100%] flex items-center justify-center">
                        <img src={emma2} alt="my pics" className='w-[90%] lg:w-[500px] md:w-[500px]  rounded-full' data-aos="fade-left" data-aos-duration="3000"/>
                    </div>
                </div>
            </div>
        );
